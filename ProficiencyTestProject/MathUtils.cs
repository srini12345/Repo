...
namespace ProficienyTestProject
{
        ...
        public class MathUtils
        {
            ...
            public static double Average(int a, int b)
            {
                ...
                double mNumberofIntergers = 2; //To find avg of 2 integers Declaring constant 2 as double, 
                return (a + b) / mNumberofIntergers; //then use the expression (a+b)/n, n is the number of integers as input
            }
        }
